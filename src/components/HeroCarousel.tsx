...
interface CarouselSlide {
  ...
  image: string;
  ctaText: string;
  targetId: string; // Product id to link to
}
...
const SLIDES: CarouselSlide[] = [
  {
    ...
    subtitle: "Immerse yourself in pure acoustic precision. The pinnacle of Active Noise Cancellation technology.",
  ...
  },
  {
    ...
    subtitle: "Timeless Swiss automatics, hand-forged 18K rose gold casing, and legendary sapphire craftsmanship.",
  ...
  },
  {
    ...
    title: "HyperGlide V2",
    subtitle: "Unlocking energy returning carbon plate soles and ultra-durable FlyKnit comfort grids.",
    ...
    <div className="relative w-full h-[320px] sm:h-[450px] overflow-hidden rounded-premium bg-slate-900 shadow-xl group">
      ...
      <div className="absolute inset-y-0 left-0 z-20 flex items-center px-6 sm:px-12 md:px-16 w-full sm:w-2/3 md:w-1/2">
        ...
        >
          ...
          <button
            onClick={() => onNavigate('product-details', { id: SLIDES[current].targetId })}
