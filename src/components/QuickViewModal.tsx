          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 flex flex-col justify-between">
              <div>
                ...
                {/* Swatches (Colors) */}
                <div className="mb-5">
                  <h4 className="text-xs font-bold text-slate-400 uppercase mb-2">Selected Color: {selectedColor?.name}</h4>
                ...
                {product.sizes && product.sizes.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-xs font-bold text-slate-400 uppercase mb-2">Selected Size: {selectedSize}</h4>
