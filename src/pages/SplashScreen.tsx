        ...
        {[...Array(15)].map((_, i) => (
          <motion.div
            ...
            className={`absolute h-2.5 w-2.5 rounded-full ${
              i % 3 === 0 ? 'bg-cyber-cyan' : i % 3 === 1 ? 'bg-cyber-gold' : 'bg-brand-500'
            }`}
          />
        ))}
      </div>
      ...
      <div className="flex flex-col items-center max-w-sm w-full px-6">
        ...
        >
          ...
          <div id="splash-logo-fallback" className="hidden relative z-10">
            <svg className="h-32 w-32 text-white fill-current" viewBox="0 0 100 100">
              <rect width="100" height="100" rx="25" fill="#FF6B00" />
              <path d="M30 35 L45 35 L55 65 L75 65" stroke="white" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" />
