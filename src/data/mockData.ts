...
export const BRANDS = [
  { name: "Sony", logo: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=120&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" },
  { name: "Apple", logo: "https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=120&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" },
  { name: "Bose", logo: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=120&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" },
  { name: "Rolex", logo: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=120&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" },
  { name: "Dyson", logo: "https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=120&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" },
  { name: "Nike", logo: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=120&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" }
];
...
const MOCK_REVIEWS: ProductReview[] = [
  {
    ...
    rating: 5,
    date: "2026-06-15",
    comment: "Absolutely outstanding. The build quality is unreal, and the product behaves exactly as advertised. Totally worth the premium cost.",
    verified: true,
    likes: 42
  },
  {
    ...
    rating: 4,
    date: "2026-06-20",
    comment: "Very sleek design. The integrations are flawless. My only complaint is that the charging cable is a bit short. Otherwise, 5 stars!",
    verified: true,
    likes: 18
  },
  {
    ...
    rating: 5,
    date: "2026-06-28",
    comment: "This is the second item I've bought from this brand. They never fail to deliver luxury quality. Delivery was super fast too, arrived next day.",
    verified: true,
    likes: 29
  },
  {
    ...
    rating: 3,
    date: "2026-07-01",
    comment: "It works well and looks beautiful, but the configuration took a bit longer than I expected. Good product, but slightly overpriced.",
    verified: false,
    likes: 5
  }
];
...
export const PRODUCTS: Product[] = [
  // AUDIO
  {
    ...
    description: "Experience premium active noise cancelling like never before. The AeroPulse ANC Pro headphones feature hybrid adaptive ANC, high-fidelity spatial audio, and an ultra-breathable mesh headband for unmatched comfort during extended listening sessions.",
    price: 399,
    discountPrice: 329,
    discount: 17,
    rating: 4.8,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  },
  {
    ...
    description: "The Synapse Air wireless earbuds provide immersive studio-quality sound in a pocket-sized package. Designed with custom-engineered acoustic drivers and active pressure relief, these earbuds deliver comfort that lasts all day.",
    price: 199,
    discountPrice: 159,
    discount: 20,
    rating: 4.6,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  // WEARABLES
  {
    ...
    description: "Meet the future of luxury smartwatches. The Chronos Horizon S3 combines high-grade titanium construction, a gorgeous curved AMOLED micro-display, and comprehensive health diagnostics including ECG, heart-rate variability, and SpO2 tracking.",
    price: 450,
    discountPrice: 389,
    discount: 13,
    rating: 4.9,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  },
  {
    ...
    description: "The PulseFit Band Active is a lightweight, ergonomic fitness tracker built to monitor your activity, sleep, and recovery. Equipped with an ultra-bright OLED screen, it logs workouts, blood oxygen levels, and stress indexes automatically.",
    price: 120,
    discountPrice: 89,
    discount: 25,
    rating: 4.4,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1575311373937-040b8e1fd5b6?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  // LUXURY TIMEPIECES
  {
    ...
    description: "Designed for the sophisticated connoisseur. The Vanguard Chronograph Lux represents the absolute peak of horological excellence. Boasting a mechanical, self-winding movement housed in an exquisite 18-karat rose gold alloy shell, this watch is as much an heirloom as it is an statement.",
    price: 24500,
    discountPrice: 19800,
    discount: 19,
    rating: 4.95,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1547996160-81dfa63595aa?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  },
  {
    ...
    description: "The Classic Heritage Monolith pays homage to minimalist design, featuring a slim case profile and a pristine ceramic bezel. The automatic movement runs with flawless precision.",
    price: 1500,
    discountPrice: 1290,
    discount: 14,
    rating: 4.7,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1619134778706-7015533a6150?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  // FASHION MENSWEAR
  {
    ...
    description: "Engineered to keep you dry and warm in the harshest environments. This parka utilizes a multilayer technical membrane that blocks freezing winds and driving rain while allowing internal moisture to escape, keeping you perfectly ventilated.",
    price: 299,
    discountPrice: 229,
    discount: 23,
    rating: 4.7,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1544923246-77307dd654cb?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  },
  {
    ...
    description: "Designed for the modern woman on the go. The AeroKnit Blazer Dress seamlessly transitions from office wear to high-end social dinners. Knit with structured organic cotton yarn that resists creasing and moves with you.",
    price: 180,
    discountPrice: 145,
    discount: 19,
    rating: 4.8,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  // SHOES
  {
    ...
    description: "Engineered with futuristic foam-mesh lattices. The HyperGlide Elements V2 sneakers offer unprecedented energy return and cushioning. The custom knitted upper hugs your foot like a second skin, offering breathability and custom lock-ins.",
    price: 250,
    discountPrice: 195,
    discount: 22,
    rating: 4.85,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  // HOME FURNITURE
  {
    ...
    description: "The ultimate seating machine. Featuring a dynamic spinal support system that adjusts automatically to your movements, high-res mesh ventilation, and customized 4D armrest controls, the Helix Chair lets you work comfortably for hours.",
    price: 699,
    discountPrice: 549,
    discount: 21,
    rating: 4.75,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1580481072645-022f9a6dbf27?w=800&auto=format&fit=crop&q=80"),
    colors: [
  ...
  },
  {
    ...
    description: "Purify and regulate your home air with extreme intelligence. The Vortex Purifier dynamically senses air quality particles (PM2.5, PM10, VOCs) in real-time, capturing 99.97% of fine allergens while blowing cool or heated clean air.",
    price: 650,
    discountPrice: 580,
    discount: 10,
    rating: 4.8,
    ...
    threeSixtyImages: gen360Angles("https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=800&auto=format&fit=crop&q=80"),
    colors: [
...
const extraSubCategories = ["audio", "cameras", "accessories", "smartwatches", "fitness", "timepieces", "accessories-lux", "menswear", "womenswear", "shoes", "furniture", "appliances"];
...
const adjectives = ["Apex", "Omni", "Quantum", "Zephyr", "Luxe", "Veloce", "Aero", "Horizon", "Infinity", "Helios", "Vector", "Carbon"];
const productTypes: Record<string, string[]> = {
  audio: ["Wireless Headphones", "Studio Speakers", "Soundbars", "Pocket Buds"],
  cameras: ["Vlog Mirrorless Camera", "Cinematic Action Cam", "Pro Gimbal Stabilizer"],
  accessories: ["MagSafe Charger Pad", "Super-fast Charging Hub", "Thunderbolt 4 Cable"],
  smartwatches: ["Elite Smart Watch", "Classic Chrono Smart", "Carbon Hybrid Watch"],
  ...
  "accessories-lux": ["Saddle Leather Briefcase", "Luxury Travel Wallet", "Slim Calfskin Cardholder"],
  menswear: ["Tech-Fleece Hoodie", "Minimalist Merino Sweater", "Structured Oxford Shirt"],
  womenswear: ["Silk Drapery Trench", "Linen Shift Dress", "Tailored Pleated Trouser"],
  shoes: ["Knit Cushioned Trainers", "High-Top Element Sneakers", "Low-Profile Skate Shoes"],
  furniture: ["Oak Drafting Desk", "Boucle Accent Lounge", "Floating Media Console"],
  appliances: ["Espresso Micro-Brewer", "Multi-cyclone Hand Vacuum", "Smart Aromatherapy Diffuser"]
};
...
for (let i = 1; i <= 42; i++) {
  ...
  const basePrice = Math.floor(50 + (i * 37) + (subCategory === "timepieces" ? 1200 : 0));
  ...
  PRODUCTS.push({
    ...
    sizes: subCategory === "menswear" || subCategory === "womenswear" ? ["S", "M", "L", "XL"] : subCategory === "shoes" ? ["8", "9", "10", "11"] : undefined,
    specifications: {
