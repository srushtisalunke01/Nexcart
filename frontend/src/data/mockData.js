...
PRODUCTS.forEach((p) => {
  ...
  p.questions = [
    {
      q: "Is the international warranty applicable?",
      a: "Yes, NEXUS Official products include a 1-year global warranty.",
      user: "StarkFan99",
    },
    {
      q: "Does it support quick pairing?",
      a: "Yes, it integrates seamlessly with the NexCart device ecosystem.",
      user: "TechGuru",
    },
  ];
});
...
const COMMUNITY_SEEDS = [
  {
    ...
    description:
      "Selling my custom modified keyboard. Features Gateron Black Ink V2 switches, hand-lubed, custom case foam, and premium PBT double-shot keycaps. Works flawlessly, selling to fund another build.",
    price: 180,
    discountPrice: 150,
    discount: 16,
    rating: 4.7,
    ...
    colors: [{ name: "Retro Beige", code: "#e2e8f0" }],
    specifications: {
    ...
    questions: [
      {
        q: "Are the keycaps included in the sale?",
        a: "Yes, the keycaps shown in the pictures are included.",
        user: "KeyboardCat",
      },
    ],
  },
  {
    ...
    description:
      "Compact drone with 4K camera and 3-axis stabilization. Includes 3 extra batteries, remote controller, landing pad, and carrying case. Scratched slightly on landing gear, but flys beautifully.",
    price: 320,
    discountPrice: 280,
    discount: 12,
    rating: 4.2,
    ...
    colors: [{ name: "Carbon Matte", code: "#1e293b" }],
    specifications: {
    ...
    questions: [
      {
        ...
        a: "About 6 months, flown roughly 12 times total.",
        user: "SkyPilot",
      },
    ],
  },
...
const BUSINESS_SEEDS = [
  {
    ...
    description:
      "Registered wholesale listing for retailers and office supplies. 50-pack high-speed USB-C to USB-C charging cables. Durable nylon braided exterior, supports 100W Power Delivery (PD 3.0), gold-plated connector pins. Individually packaged.",
    price: 350,
    discountPrice: 299,
    discount: 14,
    rating: 4.9,
    ...
    sellerVerified: true,
    sellerLogo:
      "https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=120&auto=format&fit=crop&q=60",
    moq: 2,
    priceTiers: [
      { qty: 2, price: 299 },
      { qty: 5, price: 279 },
    ...
    questions: [
      {
        q: "Can we request custom branding?",
        a: "Yes, for orders exceeding 50 packs, custom logo printing is available.",
        user: "TechRetailer",
      },
    ],
  },
  {
    ...
    description:
      "Premium office chairs wholesale. Pallet options available. Back lumbar support mesh, high quality casters, 4D armrests, full class 4 cylinder certifications. 3-year warranty included.",
    price: 2500,
    discountPrice: 2200,
    discount: 12,
    rating: 4.8,
    ...
    colors: [{ name: "Stealth Black", code: "#0f172a" }],
    specifications: {
    ...
    questions: [
      {
        q: "Is shipping included for residential addresses?",
        a: "Yes, although freight trucks must be able to access the delivery site.",
        user: "HomeDesigns",
      },
    ],
  },
