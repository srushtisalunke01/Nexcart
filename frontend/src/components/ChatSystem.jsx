...
export const ChatSystem = () => {
  const { activeChat, sendChatMessage, respondToOffer, setActiveChatSession } =
    useMarketplace();
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-xs truncate max-w-[200px] leading-tight flex items-center gap-1">
                  {activeChat.sellerType === "business" ? (
                    <Building className="h-3 w-3 text-brand-200" />
                  ) : (
              ...
              return (
                ...
                >
                  <div className="space-y-1 max-w-[80%]">
                        ...
                        <div className="mt-3 p-3 rounded-xl border border-dashed border-brand-300 bg-brand-50/10 dark:border-brand-500/30 flex flex-col gap-2">
                          ...
                          {msg.offerStatus === "pending" ? (
                            !isBuyer ? (
                              ...
                              <span className="text-[9px] text-amber-500 text-center font-bold">
                                Awaiting Seller Review
                              </span>
                            )
                          ) : (
                            <span
                              className={`text-[10px] font-bold text-center uppercase tracking-widest ${msg.offerStatus === "accepted" ? "text-green-500" : "text-red-550"}`}
                            >
                    ...
                    <div
                      className={`flex items-center gap-1.5 text-[9px] text-slate-400 font-semibold ${isBuyer ? "justify-end" : "justify-start"}`}
                    >
            ...
            {activeChat.typing && (
              <div className="flex justify-start">
                <div className="bg-slate-100 dark:bg-slate-900 rounded-2xl rounded-tl-none p-3 max-w-[80%] flex items-center gap-1.5">
                  <span className="text-[10px] font-semibold text-slate-450 italic">
                    Seller is typing
                  </span>
          ...
          <div className="p-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
            ...
            {activeChat.sellerType === "individual" && (
              <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 px-3.5 py-2.5 rounded-xl">
                ...
                >
                  ...
                  {showNegotiate ? "Cancel Offer" : "Make an Offer"}
                </button>
                {showNegotiate && (
                  <form
                    onSubmit={handleSendOffer}
                    className="flex gap-2 items-center flex-1 ml-4 justify-end"
                  >
                    <input
                      type="number"
                      required
            ...
            <form
              ...
              className="relative flex items-center bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden"
            >
              <input
                type="text"
