  ...
  const handleSocialLogin = async (platform) => {
    ...
    try {
      ...
      if (response.success) {
        if (onLoginSuccess) {
          onLoginSuccess(
            response.email || `${platform.toLowerCase()}user@nexcart.com`,
          );
        }
        onNavigate("home");
      } else {
        ...
        <div className="hidden md:flex md:w-[45%] bg-slate-50 dark:bg-slate-900/40 relative flex-col justify-between p-8 overflow-hidden border-r border-slate-100 dark:border-slate-800/40">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs text-slate-450 dark:text-slate-500 mt-2 font-medium flex items-center gap-1">
              <Sparkles className="h-3.5 w-3.5 text-brand-500" /> Shop Beyond
              Limits
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-1">
                <div className="flex items-center">
                  ...
                  <label
                    className="ml-2 block text-xs font-bold text-slate-500 dark:text-slate-400"
                    htmlFor="remember-me"
                  >
                    Remember me
                  </label>
              ...
              <a
                ...
                onClick={async (e) => {
                  ...
                  try {
                    ...
                    if (response.success) {
                      alert(
                        "Registration simulation completed. Logging you in automatically.",
                      );
                      if (onLoginSuccess) onLoginSuccess("guest@nexcart.com");
                      onNavigate("home");
                    }
